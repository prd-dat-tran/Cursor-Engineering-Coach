...
/* ---- Model request-cost multipliers (relative capability/cost tier) ---- */
/* Source: Cursor models & pricing — https://cursor.com/docs/models
 * 0 = included/free pool, <1 = light, 1 = standard, >1 = frontier. */
export const MODEL_MULTIPLIERS: Record<string, number> = {
  ...
  'gpt-5.3-codex': 1, 'gpt-5.4': 1, 'gpt-5.4-mini': 0.33, 'gpt-5.4-nano': 0.33, 'gpt-5.5': 1,
  ...
  'claude-opus-4.7': 7.5, 'claude-opus-4.8': 7.5,
  'claude-haiku-4.5': 0.33,
  'composer-2.5': 1, 'composer-2': 1, 'composer-1.5': 1, 'composer-1': 1,
  'gemini-2.0-flash': 0.25, 'gemini-2.5-pro': 1, 'gemini-3-flash': 0.33,
  'gemini-3-pro': 1, 'gemini-3.1-pro': 1, 'gemini-3.5-flash': 0.33,
  'grok-code-fast-1': 0.25, 'grok-4.3': 1, 'grok-4.20': 1, 'grok-build-0.1': 0.33,
  'kimi-k2.5': 0.33, 'raptor-mini': 0, 'goldeneye': 1,
...
export const MODEL_TOKEN_RATES: Record<string, TokenRate> = {
  ...
  'composer-2.5':       { input: 0.50, cached: 0.20,  output: 2.50 },
  'composer-2':         { input: 0.50, cached: 0.20,  output: 2.50 },
  ...
  'claude-opus-4.8':    { input: 5.00, cached: 0.50,  output: 25.00, cacheWrite: 6.25 },
