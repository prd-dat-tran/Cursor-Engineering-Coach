...
# When Triggered
{{pct}} of all requests ({{count}}/{{total}}) are in "{{extra.topWorkspace}}". Cursor can help across all your projects.

# How to Improve
Try using Cursor in other workspaces too. It can help with documentation, testing, DevOps, and exploratory coding across your entire workflow.
