...
# How to Improve
Create a `.cursor/rules/*.mdc` rule file (plain `.md` in `.cursor/rules` is ignored — it needs frontmatter) or an `AGENTS.md` in your workspace to give Cursor persistent context about your project conventions, stack, and coding style.
