...
# When Triggered
{{count}} terminal commands ({{pct}} of Cursor requests) ran directly on your host machine without a devcontainer. Agent-driven terminal commands can modify system state, install packages, or delete files outside the project.
