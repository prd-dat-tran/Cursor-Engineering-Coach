...
<div id="app">
  <nav id="sidebar">
    <ul class="nav-links">
      ...
      <li><a href="#" data-page="usage"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 14a6 6 0 1 1 12 0" stroke="currentColor" stroke-width="1.3" fill="none" stroke-linecap="round"/><line x1="8" y1="8" x2="11" y2="5.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/></svg></span> Usage</a></li>
      <li><a href="#" data-page="models"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="4" y="4" width="8" height="8" rx="1.5" stroke="currentColor" stroke-width="1.2"/><path d="M6.5 1.5v2M9.5 1.5v2M6.5 12.5v2M9.5 12.5v2M1.5 6.5h2M1.5 9.5h2M12.5 6.5h2M12.5 9.5h2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg></span> Models</a></li>
      <li><a href="#" data-page="changelog"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 6h2l6-3v10L5 10H3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1z" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M5 10v3h2" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/></svg></span> Changelog</a></li>
